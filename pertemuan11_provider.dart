...
class Pertemuan11Provider extends ChangeNotifier {
  ...
  final hp = {
    'data' : [
      ...
      {
        'model': 'Sony Xperia Z',
        'img' : 'https://upload.wikimedia.org/wikipedia/commons/thumb/8/84/Sony_Xperia_Z.jpg/220px-Sony_Xperia_Z.jpg',
  ...
  final laptop = {
    'data' : [
      ...
      {
        'model': 'HP EliteBook',
        'img' : 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/HP_Elitebook_820_G4.png/220px-HP_Elitebook_820_G4.png',
        'developer' : 'HP',
        'price' : 2500000,
        'rating' : 4.8
      }
